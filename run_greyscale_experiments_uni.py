...
if __name__ == '__main__':
    ...
    parser.add_argument('--anneal-alpha-init', type=float, default=0.9)
    parser.add_argument('--anneal-gamma', type=float, default=0.995)
    ...
    for e in range(EPOCH):
        ...
        train_loss = 0.0
        train_N = 0
        for (x_in, _), (x_in_2, _), x_out in zip(train_loader, train_loader_2, oe_dataloader):
            optimizer.zero_grad()
            x_in    = x_in.to(device)
