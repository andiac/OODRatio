...
parser.add_argument('--model', type=str, default='ResNet18', choices=['ResNet18', 'ResNet34', 'ResNet50', 'ResNet101', 'ResNet152', 'WideResNet2810'])
...
for e in range(EPOCH):
    ...
    train_loss = 0.0
    train_N = 0
    for (x_in, _), (x_in_2, _), x_out in zip(train_loader, train_loader_2, ood_train_loader):
        optimizer.zero_grad()
        x_in    = x_in.to(device)
    ...
    wandb.log({"train_loss": train_loss / train_N,
               ...
               "cifar100_scores": cifar100_scores,
